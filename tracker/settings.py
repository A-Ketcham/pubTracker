...
#
#  heroku config:set DJANGO_SECRET_KEY='xt&6$n(3+!3i*c#m_lx2pl(fdqb(j1c4+x!*1!vioe3@psw9$n'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = 'xt&6$n(3+!3i*c#m_lx2pl(fdqb(j1c4+x!*1!vioe3@psw9$n'
...
# if the environment variable is not defined then default to tracker_db.sqlite3.
